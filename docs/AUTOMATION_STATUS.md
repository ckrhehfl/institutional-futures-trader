...
| Discord-1b/1c/2a/2b/3a/3b/3c/4a/4b/5 rollout | `DESIGNED_ONLY` | rollout 단계만 문서화되어 있습니다. Discord-1a MVP 완료가 slash command, watcher, fixer, resolver, dashboard 구현 승인을 의미하지 않습니다. |

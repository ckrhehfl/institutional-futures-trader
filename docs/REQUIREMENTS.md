...
- `paper`: 기본 실행 모드이며 real exchange order를 제출하지 않는다.
- `demo`: exchange-provided demo/sandbox 환경을 사용하되 core path는 paper/live와 최대한 동일해야 한다.
